...
set fp_units            micro
set fp_top_partition    "float_mult"         ; # INPUT REQUIRED: Top partition name
...
set pg_ring_net_order           {VDD VSS}          ; # Order to create rings, e.g. {VDD GND}
...
set pg_stripe_vlayers	        {metal6}	    ; # Layers for vertical stripes, e.g. {METAL5}
...
set pg_stripe_spacing	        0.14u       ; # Spacing between stripes
...
# add WELLTAPS
set fp_well_tap_prefix            "well"                 ; # Specify the instance naming prefix; must be set to initiate welltap insertion
set fp_well_tap_cell              "WELLTAP.gds"                 ; # Specify the lib_cell used for well taps, e.g. WELL_TAP_LIB_CELL
