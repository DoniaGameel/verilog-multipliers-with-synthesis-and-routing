...
##########################################################################################################################
set MGC_importVerilogNetlist "${workdir}/verilog/demo_wallace_tree.syn.v"                     ; # REQUIRED: Path to vg netlist.  Multiple files/wildcards allowed, but must 
                                                      #           match vg files only. NOT REQUIRED FOR mxdb flow.
set MGC_topDesign            "wallace_tree"                ; # REQUIRED  : Name of top level module in verilog netlist(s).
