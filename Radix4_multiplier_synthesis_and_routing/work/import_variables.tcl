...
set workdir  "/home/vlsi/Desktop/Radix4/Lab3_2022" ;        # REQUIRED: Path to project home
...
##########################################################################################################################
set MGC_importVerilogNetlist "${workdir}/RadixBooth/verilog/demo_RadixBooth.syn.v"                     ; # REQUIRED: Path to vg netlist.  Multiple files/wildcards allowed, but must 
                                                      #           match vg files only. NOT REQUIRED FOR mxdb flow.
set MGC_topDesign            "RadixBooth"                ; # REQUIRED  : Name of top level module in verilog netlist(s).
