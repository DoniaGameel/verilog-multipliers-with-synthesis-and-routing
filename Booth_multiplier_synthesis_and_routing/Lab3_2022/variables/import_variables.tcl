...
set workdir  "/home/vlsi/Desktop/Booth/Lab3_2022" ;        # REQUIRED: Path to project home
...
##########################################################################################################################
set MGC_importVerilogNetlist "${workdir}/Booth/verilog/demo_Booth.syn.v"                     ; # REQUIRED: Path to vg netlist.  Multiple files/wildcards allowed, but must 
                                                      #           match vg files only. NOT REQUIRED FOR mxdb flow.
set MGC_topDesign            "Booth"                ; # REQUIRED  : Name of top level module in verilog netlist(s).
