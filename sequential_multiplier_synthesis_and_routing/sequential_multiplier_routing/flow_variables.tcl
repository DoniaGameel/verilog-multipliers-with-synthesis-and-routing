...
###################################################################
set MGC_powerEffort low                   ; # ADVANCED: Possible values are: none (default), low, medium, high : passed to a RPT; RCT and RRT
set MGC_powerCorner "corner_0_0"                     ; # ADVANCED: Defines the enabled setup corner to use for dynamic power analysis
set MGC_leakageCorner "corner_0_0"                   ; # ADVANCED: Defines the corner for leakage power analysis (MGC_powerCorner is used if empty)
...
set MGC_ck_buf_cell_list {CLKBUF_*}                ; # ADVANCED: Acceptable list of library buffer cells on the clock network 
...
set MGC_cts_max_skew 0.2n                 ; # REVIEW  : Target maximum skew
