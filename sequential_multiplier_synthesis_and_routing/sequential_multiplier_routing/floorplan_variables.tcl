...
set fp_units            micro
set fp_top_partition    "sequential_multiplier"         ; # INPUT REQUIRED: Top partition name
...
set pg_stripe_net_order	        {VDD VSS}      ; # Order of supply nets for stripes, e.g. {VDD GND}
