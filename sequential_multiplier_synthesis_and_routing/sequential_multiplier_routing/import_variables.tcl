...
set workdir  "/home/vlsi/Desktop/Lab5_2022" ;        # REQUIRED: Path to project home
...
##########################################################################################################################
set MGC_importVerilogNetlist "${workdir}/verilog/demo_sequential_multiplier.syn.v"                     ; # REQUIRED: Path to vg netlist.  Multiple files/wildcards allowed, but must 
                                                      #           match vg files only. NOT REQUIRED FOR mxdb flow.
set MGC_topDesign            "sequential_multiplier"                ; # REQUIRED  : Name of top level module in verilog netlist(s).
