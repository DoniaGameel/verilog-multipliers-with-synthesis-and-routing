...
#### Generic variables
#############################################################
set MGC_cpus 16                       ; # ADVANCED: Used for config_app, recommanded to use 16
set MGC_no_exit false                 ; # ADVANCED: Save design data base and exit the flow after each stage
...
###################################################################
set MGC_MaxRouteLayer {}              ; # ADVANCED: Max routing layer
set MGC_replace_dfm true              ; # ADVANCED : Set to true to enable DFM via replacement

###################################################################
### EXPORT flow variables
###################################################################
set MGC_filler_lib_cells ""                ; # REQUIRED:  Place Fillers with filler lib cell pattern 
