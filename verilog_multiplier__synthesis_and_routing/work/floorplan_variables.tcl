...
set fp_units            micro
set fp_top_partition    "integrationMult"         ; # INPUT REQUIRED: Top partition name
...
set pg_stripe_start_vmargin     0u		; # Offset from bottom of chip to beginning of vertical stripes
set pg_stripe_stop_vmargin      0u		; # Offset from top of chip to end vertical stripes
...
# Trim PG nets?
set pg_trim     false    ; # If trimming of PG tails is not desired, set to false
